...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        recipe1 = sample_recipe(user=self.user, title="Something 1")
        recipe2 = sample_recipe(user=self.user, title="Something 2")
        recipe3 = sample_recipe(user=self.user, title="Something 3")
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name="Honey")
        ingredient2 = sample_ingredient(user=self.user, name="Bacon")
